            ...
            <div className="row p-4 pe-lg-0 align-items-center rounded-3 border shadow-lg">
              <div className="col-lg-8 p-3 p-lg-5 pt-lg-3">
                  ...
                  <div className="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
                    <p>Vote average: <FontAwesomeIcon icon={faStar} style={{color: "#63E6BE",}} /> {movie.vote_average}</p>
                    <p>Votes: <FontAwesomeIcon icon={faSquarePollVertical} style={{color: "#B197FC",}} /> {movie.vote_count}</p>
                  </div>
              </div>
